<!--
	...
	This will be the main container that sets up some draggable (swatches), and a drop zone.

	We'll mount a couple of these to demonstrate cross component dragging
-->
<script setup>
...
// helper to generate a bunch of swatches for dragging
...
// handle when something is dropped on the drop zone
...
<template>
	...
	<div class="drag-demo">
		<div v-pnp-dropzone="{ keys: 'swatch', onDropped }" class="drop-zone">
